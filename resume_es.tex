...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://ccarral.github.io}{https://ccarral.github.io} & Mobile : +52-722-538-7535 \\
\end{tabular*}
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading{UAEMex, Secretaría de Planeación y Desarrollo.}{Toluca, Estado de México}
      {DBA and Automation Solutions Developer}{Jan 2021 - Jul 2021}
      % \resumeItemListStart
...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Schedule Engine}
      {Rust-programmed, embedded WASM scheduling engine that helps students create a class schedule that fits their needs. Currently at use 
      on my \href{https://uaemex.com}{alma-mater's website} and on display on my blog.}
    \resumeSubItem{mini6502}
      {Simple and lightweight 6502 emulation library written in rust.}
    \resumeSubItem{Cosmic Cube}
      {My personal blog, developed with VuePress, where I post some technical writing, do some WASM experimentation and elaborate on personal thoughts.}
  \resumeSubHeadingListEnd
...
\section{Programming Skills}
 \resumeSubHeadingListStart
  ...
  DOM with a Rust +
  \href{https://rustwasm.github.io/wasm-pack/}{wasm-pack} + Vue 3 stack.}
  \resumeSubItem{Linux kernel programming}{Knowledgeable in kernel internals and debugging tools.}
